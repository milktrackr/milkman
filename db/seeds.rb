...
Measurement.create({raw:195,read_time:Time.now-(6*1800)})
...
Measurement.create({raw:195,read_time:Time.now-(15*1800)})
Measurement.create({raw:195,read_time:Time.now-(16*1800)})
